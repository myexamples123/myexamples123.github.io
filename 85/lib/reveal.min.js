	...
	function layout() {
		...
		if( dom.wrapper && !isPrintingPDF() ) {
			...
			if( !config.disableLayout ) {
				...
				// cropped. To work around this we define our own --vh custom
	...
	function onDocumentKeyDown( event ) {
		...
		if( triggered === false ) {
			...
			switch( event.keyCode ) {
				...
				// h, left
				case 72: firstSlideShortcut ? slide( 0 ) : navigateLeft(); break;
				// l, right
				case 76: lastSlideShortcut ? slide( Number.MAX_VALUE ) : navigateRight(); break;
				// k, up
